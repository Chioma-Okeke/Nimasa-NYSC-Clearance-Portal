...
import { getClearanceFormsByStatusQueryOpt, getClearanceFormsQueryOpt, getPendingApprovalFormsQueryOpt } from '@/lib/query-options/clearance';
...
export default function AdminFormsPage() {
    ...
    const { data: allForms = [], isLoading: isLoadingReviewedForms } = useQuery(getClearanceFormsQueryOpt(employee?.role || ""))
                    ...
                    <Card>
                        <CardContent className="p-4">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <p className="text-2xl font-bold">{allForms.filter(f => f.status === 'APPROVED').length}</p>
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                    <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                        <TabsList className="grid w-full grid-cols-2 lg:w-[400px]">
                            ...
                            <TabsTrigger value="reviewed">All Forms</TabsTrigger>
                        </TabsList>
                    ...
                    <TabsContent value="reviewed">
                        <AllFormsCard clearanceForms={filteredForms ?? []} searchQuery={searchQuery} isLoading={isLoadingReviewedForms} />
                    </TabsContent>
                </Tabs>
